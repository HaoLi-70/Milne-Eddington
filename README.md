...
- This code has been applied to spectropolarimetric observations of the Fe I 15648.5 Å obtained by Goode Solar Telescope/NIRIS. A brief description of the inversion code can be found in:
...
- wavelength_path = [wavelength_file]
  Path to the FITS file [nl], storing the wavelength value in Å.
